    ...
    <div className={className}>
      ...
      {unassignedTags.length > 0 && (
        <div className="relative">
          ...
          {isOpen && (
            <div className="absolute z-10 mt-2 w-72 bg-background border-2 border-border rounded-lg shadow-xl p-2 max-h-80 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="space-y-1">
                {unassignedTags.map(tag => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2.5 hover:bg-primary/10 hover:text-primary rounded-md flex items-center gap-3 transition-all duration-150 group"
                  >
                    {tag.color && (
                      <div
