  ...
  return (
    <div className={clsx('space-y-6', className)}>
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Password */}
        <Card variant="glass" title="Password" className="border border-gray-800 dark:border-border">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              {onChangePassword && (
                <Button variant="outline" onClick={onChangePassword} className="border-gray-700 dark:border-primary-500 text-gray-300 dark:text-primary-400 hover:bg-[#1C1C26] dark:hover:bg-primary-900/20">
                  Change Password
                </Button>
              )}
            </div>
        ...
        <Card variant="glass" title="Two-Factor Authentication" className="border border-gray-800 dark:border-border">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <Shield className="w-5 h-5 text-blue-400 dark:text-primary-400" />
            ...
            {!formData.twoFactorEnabled && (
              <div className="flex items-start gap-2 p-3 bg-yellow-500/20 dark:bg-warning-900/20 rounded-lg border border-yellow-500/30 dark:border-warning-800">
        ...
        {/* Session Management */}
        <Card variant="glass" title="Session Management" className="border border-gray-800 dark:border-border">
          <div className="space-y-4">
            <div>
        ...
        <Card variant="glass" title="Security Notifications" className="border border-gray-800 dark:border-border">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-white dark:text-foreground">
