          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-3" role="list" aria-label="Réseaux sociaux">
                ...
                <a
                  href="#"
                  className="w-9 h-9 flex items-center justify-center rounded-full bg-[#1C1C26] hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 transition-all focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-[#0A0A0F]"
            ...
            <div>
              ...
              {subscribed && (
                <p className="mt-2 text-xs text-gray-400 text-blue-400" role="status" aria-live="polite">
        ...
        <div className="border-t border-blue-500/30 mt-10 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-300">
            ...
            <div className="flex items-center gap-6 flex-wrap">
              <Link
                href="/sitemap"
                className="hover:text-blue-400 hover:text-blue-300 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#0A0A0F] rounded"
              >
                Plan du site
              </Link>
              <Link
