      ...
      <div className="space-y-6">
        ...
        {step === 'setup' ? (
          <div className="space-y-4">
            {qrCodeUrl && (
              <div className="flex justify-center p-4 glass-effect bg-[#1C1C26] rounded-lg border border-gray-800">
            ...
            {secret && (
              <div className="space-y-2">
                <label className="block text-sm font-medium text-white">Manual Entry Key</label>
                <div className="flex items-center gap-2">
                  <code className="flex-1 px-4 py-2 bg-[#1C1C26] text-white rounded-lg font-mono text-sm break-all border border-gray-700">
                    {secret}
                  </code>
                  <Button
                    variant="outline"
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              {onCancel && (
                <Button variant="secondary" onClick={onCancel} disabled={loading} fullWidth className="border-gray-700 text-gray-300 hover:bg-[#252532] hover:text-white">
                  Cancel
                </Button>
              )}
              <Button
            ...
            {qrCodeUrl && (
              <div className="pt-4 border-t border-gray-800">
                <Button variant="ghost" onClick={handleSetup} fullWidth className="text-sm text-gray-300 hover:bg-[#252532] hover:text-white">
