  ...
  return (
    <div className={clsx('space-y-4', props.className)}>
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-2">
            {selectable && selectedRows.size > 0 && (
              <span className="text-sm text-gray-400 text-gray-400">{selectedRows.size} selected</span>
            )}
      ...
      <div className="relative">
        {selectable && (
          <div className="absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center border-r border-gray-800 border-gray-800 bg-[#1C1C26]/50 bg-[#1C1C26]/50 z-10">
