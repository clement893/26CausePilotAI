...
export default function VideoPlayer({
  ...
  return (
    <div
      className={clsx('relative bg-[#0A0A0F] rounded-lg overflow-hidden group border border-gray-800', className)}
        ...
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full h-1 bg-[#1C1C26] rounded-lg appearance-none cursor-pointer"
              style={{
            ...
            <div className="flex items-center gap-2 flex-1 justify-end">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-20 h-1 bg-[#1C1C26] rounded-lg appearance-none cursor-pointer"
                  style={{
