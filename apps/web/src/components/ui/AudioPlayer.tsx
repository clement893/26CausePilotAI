...
export default function AudioPlayer({
  ...
  return (
    <div className={clsx('glass-effect bg-[#13131A] rounded-lg border border-gray-800 p-4', className)}>
      ...
      <div className="mb-4">
        <input
          ...
          value={currentTime}
          onChange={handleSeek}
          className="w-full h-2 bg-[#1C1C26] rounded-lg appearance-none cursor-pointer"
          style={{
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={() => skip(-10)} className="rounded-full p-2 text-gray-300 text-white hover:bg-[#1C1C26]">
        ...
        <div className="flex items-center gap-2 flex-1 justify-end">
          <Button variant="ghost" size="sm" onClick={toggleMute} className="rounded-full p-2 text-gray-300 text-white hover:bg-[#1C1C26]">
          ...
          <input
            ...
            className="w-24 h-1 bg-[#1C1C26] rounded-lg appearance-none cursor-pointer"
            style={{
