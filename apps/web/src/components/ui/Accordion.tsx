  ...
  return (
    <div className={clsx('space-y-2', className)}>
      {items.map((item) => {
        ...
        return (
          <div key={item.id} className="border border-gray-800 rounded-lg overflow-hidden bg-[#13131A]">
            <button
            ...
            >
              <div className="flex items-center gap-3">
                {item.icon && <span aria-hidden="true" className="text-gray-400">{item.icon}</span>}
            ...
            {isOpen && (
              <div
                ...
                className={clsx(
                  'px-4 py-3 border-t border-gray-800 bg-[#1C1C26]/50',
