...
function AITestContent() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 from-[#1C1C26] to-[#1C1C26] py-8 px-4">
        ...
        <Card title="AI Test Interface">
          ...
          {mode === 'chat' && (
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-medium text-white">Messages</label>
          ...
          {response && (
            <Alert variant="success" title="AI Response" className="mt-6">
              <div className="text-white whitespace-pre-wrap mt-2">{response}</div>
            </Alert>
          )}
        </Card>
      </div>
