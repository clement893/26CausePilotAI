            ...
            {stats.map((stat, index) => {
              ...
              return (
                <Card key={index} className="p-6">
                  ...
                  <p className="text-3xl font-bold text-gray-900 text-white">
                    {stat.value}
                  </p>
                </Card>
              );
        ...
        <Card className="overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 bg-[#1C1C26] border-b border-gray-200 border-gray-800">
                <tr>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 text-gray-300 uppercase tracking-wider">
                    Donor
                  </th>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 text-gray-300 uppercase tracking-wider">
                    Contact
                  ...
                  <th className="px-6 py-4 text-right text-xs font-semibold text-gray-600 text-gray-300 uppercase tracking-wider">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 divide-gray-800">
                {filteredDonors.map((donor) => (
                  <tr
                    key={donor.id}
                    className="hover:bg-gray-50 hover:bg-[#252532] transition-colors"
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 text-gray-400 flex items-center gap-1">
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        <p className="text-sm text-gray-900 text-white flex items-center gap-2">
                          <Mail className="w-4 h-4 text-gray-400" />
                          {donor.email}
                        </p>
                        <p className="text-sm text-gray-500 text-gray-400 flex items-center gap-2">
