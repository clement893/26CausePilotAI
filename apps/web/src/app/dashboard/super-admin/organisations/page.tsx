        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {(organizations || []).map((org) => (
            <Card
              ...
              onClick={() => router.push(`/dashboard/super-admin/organisations/${org.id}`)}
            >
              ...
              <div className="mt-4 pt-4 border-t border-border flex items-center justify-end gap-2">
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    router.push(`/dashboard/super-admin/organisations/${org.id}`);
                  }}
                >
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    router.push(`/dashboard/super-admin/organisations/${org.id}/modules`);
                  }}
                >
