...
# Register organizations endpoints (SuperAdmin only)
api_router.include_router(
...
# Register organization donors endpoints
api_router.include_router(
    organization_donors.router,
    prefix="/organizations",
    tags=["donors"]
)

# Register platform monitoring endpoints (SuperAdmin only)
api_router.include_router(
    platform_monitoring.router,
    prefix="/platform",
